...
if("TRUE" STREQUAL "TRUE")
  set(octomap_server_SOURCE_PREFIX /home/peng/CS543_workspace/src/TrajOpt_Service/octomap_env_catcher/octomap_server)
  set(octomap_server_DEVEL_PREFIX /home/peng/CS543_workspace/src/TrajOpt_Service/octomap_env_catcher/octomap_server/build/devel)
...
if(NOT "/home/peng/CS543_workspace/src/TrajOpt_Service/octomap_env_catcher/octomap_server/build/devel/include;/home/peng/CS543_workspace/src/TrajOpt_Service/octomap_env_catcher/octomap_server/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-5.8" STREQUAL "")
  set(octomap_server_INCLUDE_DIRS "")
  set(_include_dirs "/home/peng/CS543_workspace/src/TrajOpt_Service/octomap_env_catcher/octomap_server/build/devel/include;/home/peng/CS543_workspace/src/TrajOpt_Service/octomap_env_catcher/octomap_server/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-5.8")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'octomap_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/peng/CS543_workspace/src/TrajOpt_Service/octomap_env_catcher/octomap_server/${idir}'.  Ask the maintainer 'Armin Hornung <hornunga@informatik.uni-freiburg.de>' to fix it.")
    endif()
    _list_append_unique(octomap_server_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "octomap_server;optimized;/usr/lib/libpcl_common.so;debug;/usr/lib/libpcl_common.so;optimized;/usr/lib/libpcl_kdtree.so;debug;/usr/lib/libpcl_kdtree.so;optimized;/usr/lib/libpcl_octree.so;debug;/usr/lib/libpcl_octree.so;optimized;/usr/lib/libpcl_search.so;debug;/usr/lib/libpcl_search.so;optimized;/usr/lib/libpcl_sample_consensus.so;debug;/usr/lib/libpcl_sample_consensus.so;optimized;/usr/lib/libpcl_io.so;debug;/usr/lib/libpcl_io.so;optimized;/usr/lib/libpcl_features.so;debug;/usr/lib/libpcl_features.so;optimized;/usr/lib/libpcl_segmentation.so;debug;/usr/lib/libpcl_segmentation.so;optimized;/usr/lib/libpcl_filters.so;debug;/usr/lib/libpcl_filters.so;/usr/lib/libboost_system-mt.so;/usr/lib/libboost_filesystem-mt.so;/usr/lib/libboost_thread-mt.so;pthread;/usr/lib/libboost_date_time-mt.so;/usr/lib/libboost_iostreams-mt.so;/usr/lib/libboost_serialization-mt.so;/usr/lib/libOpenNI.so;optimized;/usr/lib/libflann_cpp_s.a;debug;/usr/lib/libflann_cpp_s.a;/usr/lib/libvtkCommon.so.5.8.0;/usr/lib/libvtkRendering.so.5.8.0;/usr/lib/libvtkHybrid.so.5.8.0;/usr/lib/libvtkCharts.so.5.8.0")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/peng/CS543_workspace/src/TrajOpt_Service/octomap_env_catcher/octomap_server/build/devel/lib;/home/peng/CS543_workspace/devel/lib;/home/peng/drc_workspace/devel/lib;/opt/ros/hydro/lib)
